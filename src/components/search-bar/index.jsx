...
export default class SearchBar extends Component {
  ...
  render() {
    const { value, placeholder, maxLength, focus, disabled, fixed, customStyle } = this.props
    ...
    return (
      <View className={rootCls} style={customStyle}>
        <View className='my-search-bar__input-container'>
          <View className='my-search-bar__placeholder-wrap' style={placeholderWrapStyle}>
            <Text className='at-icon at-icon-search' />
            <Text className='my-search-bar__placeholder' style={placeholderStyle}>
              {placeholder}
            </Text>
          </View>
          <Input
          ...
          />
          <View className='my-search-bar__clear' style={clearIconStyle} onTouchStart={this.handleClear}>
            <Text className='at-icon at-icon-close' />
          </View>
          <View className='my-search-bar__scan' style={scanIconStyle} onTouchStart={this.handleScan}>
